  ...
  return (
    <section className=' relative md:-top-16  w-full flex flex-col bgg-dark md:flex-row h-[91%]'>
      ...
      <h1 className='capitalize font-jaro text-4xl md:text-5xl animate-pulse text-orange-500' 
        ...
        <Button name="Signup" onclick={() => navigate("/signup")} className='bg-orange-500 md:block border-white border-solid border mx-auto font-jaro w-32 h-12 rounded-3xl flex items-center justify-center text-black  text-2xl' hoverClassName='bg-orange-600'></Button>
      </div>
    </section>
  )
}
